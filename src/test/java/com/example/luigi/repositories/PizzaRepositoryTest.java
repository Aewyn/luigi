...
class PizzaRepositoryTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    void updateOnbestaandePizzaGeeftEenFout() {
        assertThatExceptionOfType(PizzaNietGevondenException.class)
                .isThrownBy(() -> repository.update(new Pizza(-1, "test", BigDecimal.TEN, false)));
    }
    ...
    void findByPrijsBetween() {
        ...
        assertThat(repository.findBetween(van, tot))
    ...
    @Test
    void findUniekPrijzenGeeftPrijzenOplopend() {
    ...
    void aantalPizzasPerPrijs(){
        ...
        assertThat(aantalPizzasPerPrijs).hasSize(super.jdbcTemplate.queryForObject("select count(distinct prijs) from pizzas", Integer.class));
